<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        $sql = "INSERT INTO `a_user`(`id`, `full_name`, `email`, `phone1`, `phone2`, `dob`, `occup`, `blood_type`, `gender`, `p_address`, `p_district`, `p_province`, `c_address`, `c_district`, `c_province`, `user_name`, `pass`, `c_pass`) VALUES (NULL,'$full_name','$email','$phone1','$phone2','$dob','$occup','$blood_type','$gender','$p_address','$p_district','$p_province','$c_address','$c_district','$c_province','$user_name','$pass','$c_pass')";
...
<body class= "regis_image">
    <section class="bbms">
        ...
        <form action="" method="post" class="form">
            ...
            <a href="/BBMS/Reg_Login/login/admin_login.php"><button type="submit" name="submit">Register</button></a>
