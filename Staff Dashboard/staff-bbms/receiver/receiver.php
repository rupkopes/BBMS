    ...
    <div class="bbms">
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="receiver.php" class="active">
                    <span class="material-symbols-sharp">local_hospital</span>
...
<header>
    <h1>Blood Request Management-User</h1>
</header>
<br>
...
<div id="addRequestForm" class="request">
    ...
    <form id="bloodRequestForm">
        ...
        <input type="text" id="phone" name="phone" required maxlength="10" pattern="[0-9]{10}"><br><br>
...
<div id="bloodRequests">
    <h2>Blood Requests Data for User</h2>
    <br>
    <br>
...
<td>
    ...
    // Function to filter blood requests based on name, phone number, and email
    function filterBloodRequests() {
        ...
        Array.from(rows).forEach(row => {
            ...
            if (name.includes(nameFilter) && phone.includes(phoneFilter) && email.includes(emailFilter)) {
                row.style.display = '';
            } else {
    ...
    document.getElementById('nameFilter').addEventListener('input', filterBloodRequests);
    document.getElementById('phoneFilter').addEventListener('input', filterBloodRequests);
    document.getElementById('emailFilter').addEventListener('input', filterBloodRequests);

    // Initial display of blood requests
    displayBloodRequests();
    filterBloodRequests(); // Call filter function initially
</script>
    </main>
