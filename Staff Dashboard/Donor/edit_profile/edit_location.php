...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE donor_register_data SET current_address=?, permanent_address=? WHERE Donor_id=?");
    $stmt->bind_param("ssi", $current_address, $permanent_address, $Donor_id);
